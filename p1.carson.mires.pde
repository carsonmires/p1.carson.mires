...
color buttonOneColor = 209;
color buttonTwoColor = 209;
color buttonThreeColor = 209;
color buttonFourColor = 209;
color buttonAlarmColor = 209;
color buttonHighlight = 162;
color pressedColor = color(247,174,62);
color pressedAlarmColor = color(240,46,72);
...
if(buttonOneColor == pressedColor){
   if(counter > 300){
      buttonOneColor = 209;
      counter = 0;
   ...
   stroke(66,247,57);
   textSize(45);
   text("Elevator Moving", 100,300);
   fill(66,247,57);
   rect(counter + 50,400,25,25);
   counter = counter + 1;
 }
else if(buttonTwoColor == pressedColor){
   if(counter > 300){
      buttonTwoColor = 209; 
      counter = 0;
   }
 ...
 else if(buttonThreeColor == pressedColor){
   if(counter > 300){
      buttonThreeColor = 209; 
      counter = 0;
   }
   stroke(66,247,57);
   textSize(45);
 ...
 else if(buttonFourColor == pressedColor){
   if(counter > 300){
      buttonFourColor = 209; 
      counter = 0;
   }
 ...
 else if(buttonAlarmColor == pressedAlarmColor){
      if(counter > 500){
         background(255);
         buttonAlarmColor = 209;
         counter = 0;
      }
      background(pressedAlarmColor);
      textSize(60);
      text("ALARM HAS BEEN PRESSED", 100, 300);
      counter = counter + 1;
...
void mousePressed() {
  if (overOne) {
    buttonOneColor = pressedColor;
  }
  if (overTwo) {
    buttonTwoColor = pressedColor;
  }
  if (overThree) {
    buttonThreeColor = pressedColor;
  }
  if (overFour) {
    buttonFourColor = pressedColor;
  }
  
  if(overAlarm){
   buttonAlarmColor =  pressedAlarmColor;
  }
}
